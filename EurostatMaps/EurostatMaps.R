##################################################
#       How to make Eurostat maps with R.        #
##################################################
...
cols <- hcl.colors(
  n = 7,
  palette = "Inferno", # get a palette from hcl.pals()
  rev = TRUE
)
...
p <- ggplot(data = mapping_sf) +
  ...
  labs(
    caption = "©2024 Maximilian Vollstädt. Data: Eurostat",
    title = "Median age in 2022 (EU countries)"
  )
